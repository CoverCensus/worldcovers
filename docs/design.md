...
**S2** \- As a Guest, I want to browse collections, so that I can *explore postal marking and cover records without an account.*
...
**S5** \- As a Contributor, I want to export an individual record as DOCX or PDF, and a list of records as PDF or XLSX, so that I can *share or archive collection data in formats used outside the system.*

**S6** \- As a Contributor, I want to submit new entries to an institutional collection, so that I can *contribute data for expert review.*

**S7** \- As a Contributor, I want to submit suggested edits to existing entries in an institutional collection, so that I can *propose corrections or additions for expert review.*
...
**S11** \- As an Editor, I want to view pending submissions on my assigned institutional collections, so that I can *review what needs attention.*
...
**S13** \- As an Editor, I want to approve or reject a submission, so that *institutional collection quality is maintained through expert review.*
...
**S16** \- As a Contributor, I want to submit comments on a record, so that I can *contribute observations or corrections for expert review.*
...
**S19** \- As an Editor, I want to add and edit reference works, so that contributors can *cite established catalogs and publications when documenting records.*

**S20** \- As an Administrator, I want to create new institutional collections, so that *catalogs or regional datasets can be organized in the system.*

**S21** \- As an Administrator, I want to assign Editors to institutional collections, so that *subject-matter experts can curate the collections they're qualified for.*

**S22** \- As a Contributor, I want every submission to be logged as a system transaction, so that *there is an audit trail of all contributions.*
...
**S31** \- As an Administrator, I want to import converted data into a running system, so that *prepared catalog records become available to users.*
...
**S38** \- As a Contributor, I want to apply and search by flexible tags on entries, so that *records can be classified and discovered beyond fixed catalog fields.*
...
**S43** \- As an Editor, I want to export a set of records as a typeset document ready for publication, so that *curated selections can be prepared for print or formal distribution without external layout work.*

**S44** \- As a Guest, I want to search collections by submitting an image, so that I can *find records visually similar to a cover I am investigating without needing to describe it in text.*
...
**S49** \- As a Contributor, I want to add and edit entries in my personal collection, so that I can *catalog and curate my own covers in the system.*
...
**F3** \- *Submission Workflow* (S6, S7, S8, S9, S10, S11, S12, S13, S14, S15): Contributor entry submissions, draft saving, Editor review cycle with feedback and revision requests, and queue filtering and sorting.

**F4** \- *Comment Workflow* (S16, S17): Contributor comments on records, with Editor review.
...
**F7** \- *Collection Administration* (S20, S21): Institutional collection lifecycle and Editor assignment.
...
| S5 | Export records or lists in commonly supported formats | F2 | Collection Discovery |
| S6 | Submit new entries to institutional collection | F3 | Submission Workflow |
| S7 | Submit suggested edits to institutional entries | F3 | Submission Workflow |
...
| S16 | Submit comments on a record | F4 | Comment Workflow |
...
| S20 | Create institutional collections | F7 | Collection Administration |
| S21 | Assign Editors to institutional collections | F7 | Collection Administration |
...
| S43 | Export record sets as typeset documents ready for publication | – | Backlog |
